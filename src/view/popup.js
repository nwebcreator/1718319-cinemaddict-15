        ...
        <div class="film-details__info">
          <div class="film-details__info-head">
            ...
            <div class="film-details__rating">
              <p class="film-details__total-rating">${movie.filmInfo.totalRaiting}</p>
            </div>
          </div>
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">${getFullDate(movie.filmInfo.release.date)}</td>
            </tr>
            <tr class="film-details__row">
              <td class="film-details__term">Runtime</td>
              <td class="film-details__cell">${getFormatedDuration(movie.filmInfo.runtime)}</td>
            </tr>
            <tr class="film-details__row">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">
                ${movie.filmInfo.genre.map((it) => (`<span class="film-details__genre">${it}</span>`)).join('')}
              </td>
            </tr>
          </table>
